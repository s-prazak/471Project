...
<html>
    ...
    <body>
        <?php
            ...
            echo "Search results that correspond to your query:" . "<br><br>";
//            echo "<p style='font-family:impact;'>"." Click the name of "."</p>";
            ...
            if($result->num_rows > 0){           //check if query results in more than 0 rows
                while($row = $result->fetch_assoc()){   //loop until all rows in result are fetched
                    ...
                    $holder = $row["Name"];
                    echo "ID: " . $row["Id"] . " Name:";
                    echo "<a href = adminProductPage.php?product=$holder>".$row["Name"]."</a>";
